    ...
    <div className="min-h-screen py-16">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-6">About CrowdFunded</h1>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">We encourage creative thinking and support groundbreaking ideas that push boundaries.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">We build strong connections between creators and backers who share their vision.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">We maintain the highest standards of security and transparency in all our operations.</p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-indigo-600 rounded-lg shadow-xl text-white p-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Get in Touch</h2>
          <p className="text-xl mb-6">Have questions? We'd love to hear from you.</p>
          <button className="bg-white text-indigo-600 hover:bg-indigo-50 px-8 py-3 rounded-full font-semibold">
            Contact Us
          </button>
        </div>
      </section>
