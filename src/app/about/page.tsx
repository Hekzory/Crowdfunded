    ...
    <div className="min-h-screen py-16">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="text-center">
          <h1 className="text-4xl font-bold dark:text-white mb-6">About CrowdFunded</h1>
      ...
      {/* Our Story Section */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="dark:bg-gray-800 rounded-lg shadow-lg dark:shadow-gray-700/20 overflow-hidden">
          <div className="p-8">
            <h2 className="text-3xl font-bold dark:text-white mb-6">Our Story</h2>
      ...
      {/* Values Section */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <h2 className="text-3xl font-bold dark:text-white mb-8 text-center">Our Values</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-gray-700/20">
            <div className="w-12 h-12 dark:bg-indigo-900/30 rounded-lg flex items-center justify-center mb-4">
              <svg className="w-6 h-6 dark:text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            </div>
            <h3 className="text-xl font-semibold mb-2 dark:text-white">Innovation</h3>
            <p className="dark:text-gray-300">We encourage creative thinking and support groundbreaking ideas that push boundaries.</p>
          </div>
          ...
          <div className="dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-gray-700/20">
            ...
            <p className="dark:text-gray-300">We build strong connections between creators and backers who share their vision.</p>
          </div>
          ...
          <div className="dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-gray-700/20">
            ...
            <p className="dark:text-gray-300">We maintain the highest standards of security and transparency in all our operations.</p>
          </div>
        </div>
      </section>
